...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/10/2025 às 12:55
...
(1, 'Maria Oliveira', 'Rua das Flores, 123', '11987654321', 'maria@gmail.com');
...
(1, '2025-10-17 11:53:25', 'Notebook Dell Inspiron', 'Não liga', 'Troca da placa-mãe', 'Lucas Técnico', 1200.00, 1);
...
INSERT INTO `usuarios` (`induser`, `usuario`, `fone`, `login`, `senha`) VALUES
(1, 'João Silva', '11999998888', 'joaos', 'senha123');
...
--
ALTER TABLE `usuarios`
  MODIFY `induser` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
